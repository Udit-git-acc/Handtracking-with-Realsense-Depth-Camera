...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("D:\Random Files\measure_object_distance\dnn\frozen_inference_graph_coco.pb",
                                            "D:\Random Files\measure_object_distance\dnn\mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
        ...
        self.classes = []
        with open("D:\Random Files\measure_object_distance\dnn\classes.txt", "r") as file_object:
